...
export default function WhatDriveUs() {
  return (
    <TwoColumnSection
      ...
      textSectionHeight="lg:pb-0 pb-20 -translate-y-6  lg:-translate-y-0"
      ...
      imageWidth="sm:w-[600px] w-[370px] translate-x-2 lg:translate-x-0 -translate-y-10 lg:-translate-y-10"
    />
  );
}
